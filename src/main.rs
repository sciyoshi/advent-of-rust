...
fn main() -> anyhow::Result<()> {
    ...
    match (args.year, args.day) {
        ...
        (2023, 06) => println!("{}", aoc2023::day06::solve(&input)),
        (2023, 07) => println!("{}", aoc2023::day07::solve(&input)),
        (2023, 08) => println!("{}", aoc2023::day08::solve(&input)),
        ...
        (2024, 02) => println!("{}", aoc2024::day02::solve(&input)),
        // (2024, 03) => println!("{}", aoc2024::day03::solve(&input)),
        // (2024, 04) => println!("{}", aoc2024::day04::solve(&input)),
        // (2024, 05) => println!("{}", aoc2024::day05::solve(&input)),
        // (2024, 06) => println!("{}", aoc2024::day06::solve(&input)),
        // (2024, 07) => println!("{}", aoc2024::day07::solve(&input)),
        // (2024, 08) => println!("{}", aoc2024::day08::solve(&input)),
        // (2024, 09) => println!("{}", aoc2024::day09::solve(&input)),
